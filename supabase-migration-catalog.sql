...
('2', 'kinder-bueno', '🤎', '["/kinder-ext.jpg","/kinder-int.jpg"]',
 ...
 'Soft cookie with crunchy hazelnuts, filled with authentic Kinder Bueno cream and Bueno pieces.',
 'Cookie moelleux aux noisettes croquantes, fourré à la vraie crème de Kinder Bueno et morceaux de Bueno.',
 'كوكيز طري بالبندق المقرمش، محشو بكريمة كيندر بوينو الأصلية وقطع البوينو.',
 22, true, 'new', 2),
('3', 'red-velvet', '❤️', '["/redvelvet-ext.jpg","/redvelvet-int.jpg"]',
 ...
 'Velvety red praline cookie with a gooey marshmallow center and cream cheese frosting.',
 'Cookie rouge velouté au praliné, avec cœur fondant de marshmallow et glaçage au fromage frais.',
 'كوكيز ريد فيلفيت بالبراليني، بقلب مارشميلو ذائب وطلاء جبن الكريم.',
 22, true, 'new', 3),
...
('6', 'lotus', '🌺', '["/lotus-ext.jpg","/lotus-int.jpg"]',
 ...
 'Cookie topped with crunchy hazelnuts and Biscoff spread, finished with Biscoff biscuit pieces.',
 'Cookie garni de noisettes croquantes et de pâte Biscoff, surmonté d''éclats de biscuits Biscoff.',
 'كوكيز مزين بالبندق المقرمش وكريمة بسكوف، مع قطع بسكويت بسكوف من الأعلى.',
